    ...
    <header className="bg-gray-900 border-b-4 border-red-800 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 border-2 border-red-800 flex items-center justify-center text-xs font-bold text-red-700 bg-gray-800" style={{ fontFamily: 'Courier New, monospace' }}>
            [F]
          </div>
          <div>
            <h1 className="text-lg font-bold text-white tracking-wider" style={{ fontFamily: 'Courier New, monospace' }}>CASE FILE: CENSUS CAT</h1>
            <p className="text-xs text-red-700" style={{ fontFamily: 'Courier New, monospace' }}>FEDERAL INVESTIGATION</p>
          </div>
        </div>
